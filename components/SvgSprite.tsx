    ...
    >
      <defs>
        ...
        <symbol id="fg-i-drip" viewBox="0 0 300 30" preserveAspectRatio="none">
          ...
          <g fill="currentColor">
            <path d="M14 4v12a5 5 0 0 0 10 0V4z" />
            <circle cx="19" cy="16" r="5" />
            <path d="M52 4v20a4 4 0 0 0 8 0V4z" />
            <circle cx="56" cy="24" r="4" />
            <path d="M96 4v7a6 6 0 0 0 12 0V4z" />
            <circle cx="102" cy="11" r="6" />
            <path d="M140 4v16a4.5 4.5 0 0 0 9 0V4z" />
            <circle cx="144.5" cy="20" r="4.5" />
            <path d="M186 4v9a5.5 5.5 0 0 0 11 0V4z" />
            <circle cx="191.5" cy="13" r="5.5" />
            <path d="M228 4v22a3.5 3.5 0 0 0 7 0V4z" />
            <circle cx="231.5" cy="26" r="3.5" />
            <path d="M268 4v6a5 5 0 0 0 10 0V4z" />
            <circle cx="273" cy="10" r="5" />
          </g>
        </symbol>
        ...
        <symbol id="fg-i-spatter" viewBox="0 0 200 200">
          <g fill="currentColor">
            ...
            <circle cx="58" cy="96" r="12" />
            <circle cx="120" cy="118" r="5" />
            <circle cx="166" cy="92" r="7" />
            <circle cx="26" cy="140" r="4" />
            <circle cx="88" cy="160" r="8" />
            <circle cx="140" cy="172" r="3.5" />
            <circle cx="180" cy="140" r="5" />
            <circle cx="12" cy="88" r="2.5" />
            <circle cx="98" cy="14" r="2" />
            <circle cx="184" cy="60" r="2.5" />
            <circle cx="46" cy="182" r="2.5" />
            <circle cx="158" cy="128" r="2" />
          </g>
        </symbol>
        ...
        >
          <path
            fill="currentColor"
            d="M2 9c40-5 92-7 142-4 22 1 42 3 54 5-14 3-34 4-56 4-52 1-104-2-140-5z"
          />
        </symbol>
        ...
        <symbol id="fg-i-skate" viewBox="0 0 200 66">
          <path
            fill="currentColor"
            d="M18 22c-8-10-16-14-16-6 0 7 6 12 14 14h172c8-2 14-7 14-14 0-8-8-4-16 6z"
          />
