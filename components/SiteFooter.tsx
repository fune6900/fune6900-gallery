...
export default async function SiteFooter() {
  ...
  return (
    <>
        ...
        <div className="fg-wrap">
          <div className="fg-footer__in">
            <div className="fg-footer__id">
              <svg
                className="fg-boo"
                style={{ width: 74, height: 74, color: "#fff", flex: "none" }}
                aria-hidden="true"
              >
                <use href="#fg-i-boo" />
              </svg>
              <div>
                ...
                <div
                  ...
                  style={{ width: 150, margin: "8px 0 10px" }}
                />
            ...
            <div className="fg-footer__gear">
              ...
              <nav className="fg-footer__nav" aria-label="フッターメニュー">
                <a className="fg-pill fg-pill--ghost" href="/">
                  ギャラリー
                </a>
                <a className="fg-pill fg-pill--lime" href="#top">
                  &#9650; TOP
                </a>
              </nav>
            </div>
          ...
          <div className="fg-footer__btm">
            <span>
              &copy; {new Date().getUTCFullYear()} {SITE_NAME}
            </span>
      ...
      >
        <button
          className="fg-lb__close"
          type="button"
          id="fg-lightbox-close"
          aria-label="閉じる"
        >
          &#10005;
        </button>
      ...
      <div className="fg-crt" id="fg-crt" aria-hidden="true">
        <div className="fg-crt__flash" />
      </div>
    </>
  );
}
